  ...
  <div v-if="showCurlModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4">
      ...
      <div class="p-6">
        <div class="space-y-4">
          <div>
            <label for="curl-name" class="block text-sm font-medium text-gray-700">Interface Name<span class="text-red-500">*</span></label>
            <input
              id="curl-name"
              v-model="curlName"
              type="text"
          ...
          <div>
            <label for="curl-description" class="block text-sm font-medium text-gray-700">Description</label>
            <input
              id="curl-description"
              v-model="curlDescription"
              type="text"
              class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
          ...
          <div>
            ...
            <label for="curl-command" class="block text-sm font-medium text-gray-700">cURL Command<span class="text-red-500">*</span></label>
            <textarea
              id="curl-command"
              v-model="curlCommand"
              rows="6"
...
async function importFromCurlModal() {
  ...
  try {
    ...
    const response = await $api.httpInterfaces.createFromCurl({ 
      command: curlCommand.value,
      name: curlName.value,
      description: curlDescription.value 
    });
